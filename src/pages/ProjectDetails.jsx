  ...
  return (
    ...
    <div className="bg-secondary">
      <div className="relative overflow-hidden rounded-b-[80px]">
        <section className="relative grid h-[70vh] w-full place-content-center overflow-hidden bg-background">
          <motion.h2 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="relative text-center z-0 text-[10vw] font-black text-primary md:text-[60px]"
          >
